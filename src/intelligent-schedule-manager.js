...
class IntelligentScheduleManager {
     ...
     * Calculate next smart automation window
     */
    getNextSmartWindow(currentTime, schedule) {
    ...
    getTimezoneOffset(timezone) {
        // Simplified timezone handling - in production would use proper timezone library
        const offsets = {
     ...
     */
    getOptimizationSuggestions(tier, schedule) {
        const suggestions = [];
